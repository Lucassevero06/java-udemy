...
public class InstanciandoDate {
    public static void main(String[] args) {
        ...
        DateTimeFormatter fmt2 = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm"); // passando um formato para o DateTimeFormatter
        ...
        LocalDate d08 = LocalDate.parse("31/07/2024", DateTimeFormatter.ofPattern("dd/MM/yyyy")); // passando um formato para o DateTimeFormatter
        LocalDateTime d09 = LocalDateTime.parse("31/07/2024 01:30", fmt2);

        LocalDate d10 = LocalDate.of(2024, 7, 31);

        LocalDateTime d11 = LocalDateTime.of(2024, 7, 31, 1, 30);
